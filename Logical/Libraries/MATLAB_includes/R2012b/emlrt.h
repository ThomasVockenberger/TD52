/*
 * @(#)emlrt.h    generated by: makeheader 5.1.5  Tue May 24 21:21:44 2011
 *
...
typedef struct emlrtCallStack {
    uint32_T*    fRTStackPointer;       /* expanded by numCores */
...
#define EMLRTENTERPARALLELREGION() { \
    emlrtContextGlobal.fRTCallStack->fRTStackBranch = emlrtContextGlobal.fRTCallStack->fRTStackPointer[0];  \
 ...
 */
EXTERN_C mxArray* emlrtLocationLoggingPullLog(const char* const MexFileName);
...
#define EMLRTPUSHRTSTACKR2011B(aRSInfo, aTId) { \
 if (emlrtContextGlobal.fRTCallStack->fRTStackPointer[aTId] < emlrtContextGlobal.fRTCallStack->fRTStackSize[aTId]) \
(emlrtContextGlobal.fRTCallStack->fRTStackInfo[aTId][emlrtContextGlobal.fRTCallStack->fRTStackPointer[aTId]++] = aRSInfo); \
else emlrtPushRtStackR2011b(aRSInfo,aTId); }


#define EMLRTPUSHRTSTACK(aRSInfo) { \
    if (emlrtContextGlobal.fRTCallStack->fRTStackPointer[0] < emlrtContextGlobal.fRTCallStack->fRTStackSize[0]) \
    (emlrtContextGlobal.fRTCallStack->fRTStackInfo[0][emlrtContextGlobal.fRTCallStack->fRTStackPointer[0]++] = aRSInfo); \
...
#define EMLRTPOPRTSTACKR2011B(aRSInfo, aTId) { \
    if (emlrtContextGlobal.fRTCallStack->fRTStackPointer[aTId] != 0) \
    (emlrtContextGlobal.fRTCallStack->fRTStackPointer[aTId]--); \
    else emlrtPopRtStackR2011b(aRSInfo,aTId); }


#define EMLRTPOPRTSTACK(aRSInfo) { \
    if (emlrtContextGlobal.fRTCallStack->fRTStackPointer[0] != 0) \
    (emlrtContextGlobal.fRTCallStack->fRTStackPointer[0]--); \
