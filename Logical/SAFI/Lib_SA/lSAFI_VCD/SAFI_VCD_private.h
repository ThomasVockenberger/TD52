...
#ifndef RTW_HEADER_SAFI_VCD_private_h_
#define RTW_HEADER_SAFI_VCD_private_h_
#include "rtwtypes.h"
#include "SAFI_VCD.h"
...
extern real_T rt_roundd(real_T u, struct fSAFI_VCD* inst);
extern void SAFI_VCD_FindVC(uint16_T rtu_VC_in, uint16_T rtu_WinStart, boolean_T
  rtu_bReset, real32_T rtu_StdLim, rtB_FindVC_SAFI_VCD *localB,
  rtDW_FindVC_SAFI_VCD *localDW, struct fSAFI_VCD* inst);

#endif                                 /* RTW_HEADER_SAFI_VCD_private_h_ */
